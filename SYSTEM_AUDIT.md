...
| CRS-L4 | ~~[`transcoding.py:135`](courses/transcoding.py#L135)~~ | **Fixed.** Was: always produced 240p–1080p, upscaling low-res sources. `_select_ladder` now caps the ladder at the probed source height. |
