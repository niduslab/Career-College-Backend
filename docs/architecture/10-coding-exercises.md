...
- **Sandbox constants**: `network_disabled=True`, `mem_limit=128m`, `memswap_limit=128m`, `cpu_period=100_000`, `cpu_quota=50_000` (0.5 cores), `read_only=True`, `tmpfs={'/tmp': 'size=32m,exec'}`, `cap_drop=['ALL']`, `security_opt=['no-new-privileges:true']`, `detach=True, remove=False` (manual cleanup in `finally`).
